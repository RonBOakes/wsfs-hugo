...
--
-- Host: localhost    Database: hugo2014
-- ------------------------------------------------------
...
CREATE TABLE `email_log` (
  `nominator_pin` varchar(14) NOT NULL,
  `send_time` datetime NOT NULL,
  `send_result` int(11) NOT NULL,
  `email_text` longtext DEFAULT NULL,
  PRIMARY KEY (`nominator_pin`,`send_time`)
...
CREATE TABLE `nomination_pin_email_info` (
  ...
  `source` enum('Loncon 3','LoneStarCon 3','Sasquan') NOT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=7961 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=270971 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=18872 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=20662 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `packet_files` (
  ...
  `file_short_description` varchar(45) NOT NULL,
...
-- Dump completed on 2022-12-24 13:33:47
