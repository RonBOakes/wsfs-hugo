...
As a member of Worldcon 75, you are eligible to nominate works for both awards.  The nomination period is now open, and will close on March 31, 2016 at 11:59 pm PDT.  You can find all the details for this process on the MidAmeriCon II website at http://midamericon2.org/the-hugo-awards/hugo-nominations/.
...
There are two ways to nominate: either via a paper ballot that you can print out, or through MidAmeriCon II’s online voting system. To use the online system, you will need to enter your Worldcon 75 membership number, as well as a Personal Identification Number that MidAmeriCon II has assigned to you.
...
EOT;
  ...
  $mailText .= 'Convention: Worldcon 75'."\n";
